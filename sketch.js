...
function draw() {
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    if (playerArrows[i] !== undefined) {
      ...
      //se houve colisão(collided) com o board1Collision OU board2Collision então some + 5 na variável score
  ...
  //se numberOfArrows(numero de flechas) for igual a 0 então execute gameOver()
   if (numberOfArrows == 0) {
     gameOver();
   }
